                        ...
                        <div class="product-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title product-title">
                                    <a href="../../pages/user/product_detail.php?id=<?php echo $product['id']; ?>" class="text-decoration-none text-dark">
                            ...
                            <div class="card-footer bg-white">
                                <div class="d-flex justify-content-between">
                                    <a href="../../pages/user/product_detail.php?id=<?php echo $product['id']; ?>" class="btn btn-sm btn-outline-primary">Chi tiết</a>
